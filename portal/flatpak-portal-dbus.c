...
static const _ExtendedGDBusArgInfo * const _portal_flatpak_method_info_spawn_IN_ARG_pointers[] =
{
  &_portal_flatpak_method_info_spawn_IN_ARG_cwd_path,
  &_portal_flatpak_method_info_spawn_IN_ARG_argv,
  &_portal_flatpak_method_info_spawn_IN_ARG_fds,
  &_portal_flatpak_method_info_spawn_IN_ARG_envs,
  &_portal_flatpak_method_info_spawn_IN_ARG_flags,
  &_portal_flatpak_method_info_spawn_IN_ARG_options,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _portal_flatpak_method_info_spawn_OUT_ARG_pointers[] =
{
  &_portal_flatpak_method_info_spawn_OUT_ARG_pid,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _portal_flatpak_method_info_spawn_signal_IN_ARG_pointers[] =
{
  &_portal_flatpak_method_info_spawn_signal_IN_ARG_pid,
  &_portal_flatpak_method_info_spawn_signal_IN_ARG_signal,
  &_portal_flatpak_method_info_spawn_signal_IN_ARG_to_process_group,
  NULL
};
...
static const _ExtendedGDBusMethodInfo * const _portal_flatpak_method_info_pointers[] =
{
  &_portal_flatpak_method_info_spawn,
  &_portal_flatpak_method_info_spawn_signal,
  NULL
};
...
static const _ExtendedGDBusArgInfo * const _portal_flatpak_signal_info_spawn_exited_ARG_pointers[] =
{
  &_portal_flatpak_signal_info_spawn_exited_ARG_pid,
  &_portal_flatpak_signal_info_spawn_exited_ARG_exit_status,
  NULL
};
...
static const _ExtendedGDBusSignalInfo * const _portal_flatpak_signal_info_pointers[] =
{
  &_portal_flatpak_signal_info_spawn_exited,
  NULL
};
...
static const _ExtendedGDBusPropertyInfo * const _portal_flatpak_property_info_pointers[] =
{
  &_portal_flatpak_property_info_version,
  NULL
};
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = _portal_flatpak_property_info_pointers[prop_id - 1];
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _portal_flatpak_schedule_emit_changed (skeleton, _portal_flatpak_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
